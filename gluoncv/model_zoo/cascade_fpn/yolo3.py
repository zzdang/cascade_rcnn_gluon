...
def cascade_fpn_resnet101_v1b_coco(pretrained=False, pretrained_base=True, **kwargs):
    ...
    for layer in ['conv1', 'bn1', 'relu', 'maxpool', 'layer1']:
        features2.add(getattr(base_network, layer))
    for layer in ['layer2']:
        features3.add(getattr(base_network, layer))
    for layer in ['layer3']:
        features4.add(getattr(base_network, layer))
    for layer in ['layer4']:
        features5.add(getattr(base_network, layer))