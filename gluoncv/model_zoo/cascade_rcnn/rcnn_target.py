...
class RCNNTargetSampler(gluon.HybridBlock):
    ...
    """
    def __init__(self, num_image, num_proposal, num_sample, pos_iou_thresh, pos_iou_hg_thresh, pos_ratio):
        ...
        self._pos_iou_hg_thresh = pos_iou_hg_thresh
    ...
    def hybrid_forward(self, F, rois, scores, gt_boxes):
        ...
        with autograd.pause():
            ...
            for i in range(self._num_image):
                ...
                pos_mask = ious_max >= self._pos_iou_thresh & ious_max <= self._pos_iou_hg_thresh
